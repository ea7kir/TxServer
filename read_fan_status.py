...
def _config_fan(address):
    pass

def init_fan_sensors():
    _config_fan(ENCLOSURE_INTAKE_FAN_ADDRESS)
    _config_fan(ENCLOSURE_EXTRACT_FAN_ADDRESS)
    _config_fan(PA_INTAKE_FAN_ADDRESS)
    _config_fan(PA_EXTRACT_FAN_ADDRESS)
...
def read_fan_status():
    ...
    if _read_sensor(ENCLOSURE_EXTRACT_FAN_ADDRESS): b = '2'
